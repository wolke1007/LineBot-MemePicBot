...
def check_msg_content(msg_content, trigger_chat, group_id):
    print('msg_content, msg_content, trigger_chat, group_id',msg_content, trigger_chat, group_id)
            ...
            # --mode chat_mode 1
                ...
                if system_config:
                    ...
                    reply_content = '[當前模式為]  {}, {}, {} '.format(\
                                    'chat_mode:'+str(system_config[1]), 'retrieve_pic_mode:'+str(system_config[2]), 'trigger_chat:'+str(system_config[3]))
